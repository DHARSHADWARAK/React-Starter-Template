      ...
      <div className="container mx-auto">
        ...
        <div className="text-center mb-12">
          <h2 className="text-3xl sm:text-4xl font-bold text-[#00bf63]">
            SCOPE <span className="text-blue-900">OF SERVICE</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
          {services.map((service) => (
            <div key={service.id} className="flex flex-col items-center animate-flip-in">
              {/* Icon */}
              {/* <div className="w-16 h-16 rounded-full border-2 border-blue-900 flex items-center justify-center mb-4"> */}
                <img src={service.icon} alt={service.title} className="w-[100rem]" />
              {/* </div> */}
